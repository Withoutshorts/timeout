...
if len(session("user")) = 0 then
	...
	Redim thisaktid(150)
	Redim thisaktnavn(150)
	Redim thisAktTimer(150)
	Redim thisAktBeloeb(150)
	'Redim usefastpris(150)
	Redim thisTimePris(150)
	Redim thisaktfunc(150)
	Redim thisaktfakbar(150)
	Redim thisaktfaktor(150)
	Redim thisaktsort(150)
	
	Redim thisaktrabat(150)
	
	Redim thisaktbesk(150)
	Redim thisaktForkalk(150)
	redim thisAktForkalkStk(150)
	redim thisAktBudgetsum(150)
	
	Redim thisAktEnhAng(150)
	Redim thisAktEnhPris(150)
	
	Redim thisAktValuta(150)
	Redim thisAktText(150)
	
	Redim thisaktCHK(150) 
	Redim thisaktEnh(150)
	
	redim thisAktFase(150)
	redim thisMomsfri(150)
	
	redim thisAktBgr(150)
	redim thisJoborAkt_tp(150)
