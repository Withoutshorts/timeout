	...
	'*** Finder de medarbejdere og job der er valgt ***
		...
		'end if
			...
			'	file = "joblog_"&lto&".txt"
				...
				'*** 1 linie ****
				if lto = "bowe" then
				objF.WriteLine("Uge;Dato;Kontakt;Kontakt Id;Jobnavn;Job Nr;KA Nr;Böwe kode;Aktivitet;Akt. tidslås;Medarbejder;Medarb. Nr;Initialer;Timer/Enheder;Heraf fakturerbare timer;Reg. Timepris (uanset fastpris/lbn.tim.);Gns.fak. Timepris;Kommentar;")
				else
