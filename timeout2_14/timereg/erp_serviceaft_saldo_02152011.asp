...
%>
		...
		<h3>
            <img src="../ill/ac0045-24.gif" /> Afstemning aftaler</h3> 
				...
				if print <> "j" then%>
				<div id="filterdiv" style="position:relative; left:0px; top:0px; visibility:visible; background-color:#ffffe1; border:1px #8caae6 solid; padding:10px 10px 10px 10px; width:550px;">
			...
			<%end if %>
				...
				<tr>
					<td style="padding:5px 5px 2px 35px;" colspan=2>
					<b>Periode:</b><br>
				...
				&nbsp;<a href="<%=thisfile%>?menu=kon&aftid=<%=aftid%>&kundeid=<%=kundeid%>&print=j" target="_blank" class=vmenu>Print venlig version</a>&nbsp;&nbsp;<br />
				<%end if %>
...
<br>
<div id=sidenoter style="position:relative; background-color:#FFFFe1; width:400px; border:2px orange dashed; padding:10px;">
<b>
